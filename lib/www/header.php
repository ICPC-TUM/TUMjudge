...
$cssclass = (!empty($cid) ? 'contest-'.$cid.' ' : '').'tumjudge-'.(array_key_exists('tumjudge_instance', $_GET) ? $_GET['tumjudge_instance'] : 'gcpc');
if ( IS_JURY ) {
	global $pagename;
      ...
      <ul class="nav navbar-nav">
        <li class="dropdown brand">
          ...
          <ul class="dropdown-menu" role="menu">
            ...
            <li class="page tumjudge-gcpc"><a href="https://judge.in.tum.de/judge/">GCPC <span class="description">German Collegiate Programming Contest</span></a></li>
